...
function Generate() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-6">Generate Videos</h1>

      {/* Generate Form */}
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <h2 className="text-lg font-semibold mb-4">New Generation</h2>
        
        <div className="flex items-center gap-4 mb-4">
          <label className="text-gray-600">Number of videos:</label>
          <input
            type="number"
            min="1"
            max="50"
      ...
      {job && (
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              <div className="text-2xl font-bold text-green-600">{job.completed}</div>
            ...
            <div>
              <div className="text-2xl font-bold text-blue-600">{job.count - job.completed - job.failed}</div>
